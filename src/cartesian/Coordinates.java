...
public class Coordinates {
     ...
     * public int getCartesianX(double lon, double lat){
     *     return (int)(lon/((double)180)*40000000);
     * }
     */
     ...
     * public int getCartesianY(double lon, double lat){
     *     return (int)(lat/((double)90)*20000000);
     * }
     */
...
///////////////////////////////////////////// Convert GEO / PIXEL  ///////////////////////////////////////////////
    ...
    /**
     * get converted x value of a geographical position according zoom level 1
     * @param lon
     * @param lat
     * @return cartesian X coordinate (int)
     */
     ...
     /**
     * get converted y value of a geographical position according zoom level 1 
     * @param lon
     * @param lat
     * @return cartesian Y coordinate (int)
     */
     ...
     /**
      * get converted x value of a geographical position according to given zoom level
      * @param lon
      * @param lat
      * @param zoom
      * @return cartesian X coordinate (int)
     ...
     /**
      * get converted y value of a geographical position according to given zoom level
      * @param lon
      * @param lat
      * @param zoom
      * @return cartesian Y coordinate (int)
      */
       ...
       * x, y pixel values must be normalized to zoom factor 1
       * 
       * @param x
       * @param y
       * @return GeoPosition
	 ...
	 /**
	  * convert geographical position to pixel coordinates and store as Point2D considering zoom
	  * @param lon
	  * @param lat
	  * @param zoom
	  * @return cartesian coordinate (Point2D)
...
///////////////////////////////////////////// Distances / matched Points  ////////////////////////////////////////
         ...
         */
         ...
         public static double getNearestPointY(double px, double py, double ax, double ay, double bx, double by){
             ...
             // pruefe, welcher Endpunkt (ax,ay) oder (bx,by) naeher an Punkt (px,py) liegt
             if ((m>1)||(m<0)){
                 if (getDistanceSquared(px,py,ax,ay)<getDistanceSquared(px,py,bx,by)) return ay;
                 else return by;
             }
         ...
         */
          ...
          * @param ax a point of line x position
          * @param ay a point of line y position
          * @param bx b point of line x position
         ...
         public static double getDistanceSquared(GPSNode gpsNode1, GPSNode gpsNode2) {
        	 return getDistanceSquared(gpsNode1.getX(), gpsNode1.getY(), gpsNode2.getX(), gpsNode2.getY());
         }
         ...
         public static double getDistance(GPSNode gpsNode1, GPSNode gpsNode2) {
        	 return getDistance(gpsNode1.getX(), gpsNode1.getY(), gpsNode2.getX(), gpsNode2.getY());
         }
